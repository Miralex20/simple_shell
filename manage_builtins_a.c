 ...
 */
int unset_alias(information_s *info, char *str)
{
	char *p, c;
	int ret;
 ...
 * Return: Always 0 on success, 1 on error
 */
int set_alias(information_s *info, char *str)
{
	char *p;
 ...
 * Return: Always 0 on success, 1 on error
 */
int print_alias(list_stru *node)
{
	char *p = NULL, *a = NULL;
 ...
 *	Return: Always 0
 */
int handle_alias(information_s *info)
{
	int i = 0;
	char *p = NULL;
	list_stru *node = NULL;
 ...
 */
int change_alias(information_s *info)
{
	int i;
	list_stru *node;
	char *p;
